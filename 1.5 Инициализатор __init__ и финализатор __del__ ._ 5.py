...
вызовите метод show_bar(),
затем метод set_show() со значением fl_show = False
...
class Graph:
    ...
    def decorator(foo):
        """ декоратор устранения дублирования кода
        Если локальное свойство is_show равно False, то выводит: 'Отображение данных закрыто' """
    ...
    @decorator
    def show_graph(self):
        """ выводит в консоль сообщение: "Графическое отображение данных: <строка из чисел следующих через пробел>" """
    ...
    @decorator
    def show_bar(self):
        """ выводит сообщение: "Столбчатая диаграмма: <строка из чисел следующих через пробел>" """
